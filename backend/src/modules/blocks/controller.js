...
export class BlocksController {
    async create(req, res, next) {
        try {
            ...
            const block = await blocksService.createBlock(documentId, type, content, position ?? 0, parentBlockId ?? null, userId);
    ...
    async update(req, res, next) {
        try {
            ...
            const block = await blocksService.updateBlock(id, type, content, position, parentBlockId, userId);
