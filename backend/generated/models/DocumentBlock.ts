...
// @ts-nocheck 
/*
 * This file exports the `DocumentBlock` model and its related types.
 *
...
export type GetDocumentBlockAggregateType<T extends DocumentBlockAggregateArgs> = {
      [P in keyof T & keyof AggregateDocumentBlock]: P extends '_count' | 'count'
    ? T[P] extends true
      ? number
      : Prisma.GetScalarType<T[P], AggregateDocumentBlock[P]>
    : Prisma.GetScalarType<T[P], AggregateDocumentBlock[P]>
}
...
export type GetDocumentBlockGroupByPayload<T extends DocumentBlockGroupByArgs> = Prisma.PrismaPromise<
  Array<
    Prisma.PickEnumerable<DocumentBlockGroupByOutputType, T['by']> &
      {
        [P in ((keyof T) & (keyof DocumentBlockGroupByOutputType))]: P extends '_count'
          ? T[P] extends boolean
            ? number
            : Prisma.GetScalarType<T[P], DocumentBlockGroupByOutputType[P]>
          : Prisma.GetScalarType<T[P], DocumentBlockGroupByOutputType[P]>
      }
    >
  >
...
export type DocumentBlockCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> =
  Omit<DocumentBlockFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface DocumentBlockDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
  [K: symbol]: { types: Prisma.TypeMap<ExtArgs>['model']['DocumentBlock'], meta: { name: 'DocumentBlock' } }
  /**
   ...
   * })
  **/
  count<T extends DocumentBlockCountArgs>(
    args?: Prisma.Subset<T, DocumentBlockCountArgs>,
  ): Prisma.PrismaPromise<
    T extends runtime.Types.Utils.Record<'select', any>
      ? T['select'] extends true
        ? number
        : Prisma.GetScalarType<T['select'], DocumentBlockCountAggregateOutputType>
      : number
  >
  ...
  **/
  groupBy<
    T extends DocumentBlockGroupByArgs,
  ...
  >(args: Prisma.SubsetIntersection<T, DocumentBlockGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetDocumentBlockGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>
/**
