...
export type GetDocumentCollaboratorAggregateType<T extends DocumentCollaboratorAggregateArgs> = {
    [P in keyof T & keyof AggregateDocumentCollaborator]: P extends '_count' | 'count' ? T[P] extends true ? number : Prisma.GetScalarType<T[P], AggregateDocumentCollaborator[P]> : Prisma.GetScalarType<T[P], AggregateDocumentCollaborator[P]>;
};
...
export type GetDocumentCollaboratorGroupByPayload<T extends DocumentCollaboratorGroupByArgs> = Prisma.PrismaPromise<Array<Prisma.PickEnumerable<DocumentCollaboratorGroupByOutputType, T['by']> & {
    [P in ((keyof T) & (keyof DocumentCollaboratorGroupByOutputType))]: P extends '_count' ? T[P] extends boolean ? number : Prisma.GetScalarType<T[P], DocumentCollaboratorGroupByOutputType[P]> : Prisma.GetScalarType<T[P], DocumentCollaboratorGroupByOutputType[P]>;
}>>;
...
export type DocumentCollaboratorOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "documentId" | "userId" | "role" | "joinedAt", ExtArgs["result"]["documentCollaborator"]>;
...
export type DocumentCollaboratorCountArgs<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = Omit<DocumentCollaboratorFindManyArgs, 'select' | 'include' | 'distinct' | 'omit'> & {
...
export interface DocumentCollaboratorDelegate<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs, GlobalOmitOptions = {}> {
    [K: symbol]: {
        types: Prisma.TypeMap<ExtArgs>['model']['DocumentCollaborator'];
        meta: {
            name: 'DocumentCollaborator';
        };
    };
     ...
     * })
    **/
    count<T extends DocumentCollaboratorCountArgs>(args?: Prisma.Subset<T, DocumentCollaboratorCountArgs>): Prisma.PrismaPromise<T extends runtime.Types.Utils.Record<'select', any> ? T['select'] extends true ? number : Prisma.GetScalarType<T['select'], DocumentCollaboratorCountAggregateOutputType> : number>;
    /**
    ...
    **/
     ...
     *
    **/
    groupBy<T extends DocumentCollaboratorGroupByArgs, HasSelectOrTake extends Prisma.Or<Prisma.Extends<'skip', Prisma.Keys<T>>, Prisma.Extends<'take', Prisma.Keys<T>>>, OrderByArg extends Prisma.True extends HasSelectOrTake ? {
        ...
        [P in OrderFields]: P extends ByFields ? never : `Error: Field "${P}" in "orderBy" needs to be provided in "by"`;
    }[OrderFields]>(args: Prisma.SubsetIntersection<T, DocumentCollaboratorGroupByArgs, OrderByArg> & InputErrors): {} extends InputErrors ? GetDocumentCollaboratorGroupByPayload<T> : Prisma.PrismaPromise<InputErrors>;
    /**
...
//# sourceMappingURL=DocumentCollaborator.d.ts.map