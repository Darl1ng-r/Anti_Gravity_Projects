 ...
 * `prisma.user`: Exposes CRUD operations for the **User** model.
  ...
  */
    ...
    /**
     * `prisma.documentBlock`: Exposes CRUD operations for the **DocumentBlock** model.
      * Example usage:
      * ```ts
      * // Fetch zero or more DocumentBlocks
      * const documentBlocks = await prisma.documentBlock.findMany()
      * ```
      */
    get documentBlock(): Prisma.DocumentBlockDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
     ...
     * `prisma.documentCollaborator`: Exposes CRUD operations for the **DocumentCollaborator** model.
      ...
      * ```
      */
    get documentCollaborator(): Prisma.DocumentCollaboratorDelegate<ExtArgs, {
        omit: OmitOpts;
    }>;
    /**
